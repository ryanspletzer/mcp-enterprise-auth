...
2. Pre-configured client_id (no DCR needed)
3. Token acquisition from Entra ID
4. Authenticated MCP API calls

This client HAS a pre-configured client_id registered in Entra ID.
It does NOT use DCR - credentials are provided via environment variables.
"""
...
class MCPPublicClientWithCreds:
    """MCP Public Client with pre-configured credentials."""
